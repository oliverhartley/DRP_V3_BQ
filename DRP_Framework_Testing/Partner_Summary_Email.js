...
// --- BATCH CONFIGURATION ---
const COL_PARTNER_NAME = 0;
const COL_TO_EMAIL = 49;
const COL_CC_EMAIL = 50;
const COL_STATUS = 51;       // New column added at the end for status
...
function runBatchEmailSender() {
  ...
  if (!sheet) {
    Logger.log(`ERROR: '${SHEET_NAME_SOURCE}' sheet not found in Source SS.`);
    return;
  }
